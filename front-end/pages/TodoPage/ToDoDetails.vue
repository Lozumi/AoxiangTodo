        ...
        <v-container>
                        ...
                        <v-dialog v-model="_dialog"
                          ...
                          <v-card>
                            ...
                            <v-card-actions>
                              <v-btn color="primary"
                                     block
                                     @click="_dialog = false">关闭
                              </v-btn>
                            </v-card-actions>
                            <v-card-actions>
                              <v-btn color="primary"
                                     block
                                     @click="_dialog = false; removeFolder(tile.title)">确定
                              </v-btn>
                            </v-card-actions>
                          </v-card>
                        </v-dialog>
            ...
            <v-container>
              ...
              <!--任务重要程度设置-->
                  ...
                  <v-expansion-panels>
                    <v-expansion-panel
                        :title="importancePriorityTitle"
                        :color="importancePriorityColor"
                    >
              ...
              <!--任务重要程度设置-->
                  ...
                  <v-expansion-panels>
                    <v-expansion-panel
                        :title="emergencyPriorityTitle"
                        :color="emergencyPriorityColor"
                    >
                      <v-expansion-panel-text>
                        <v-list>
